...
# 페이지 설정 (배경색 등 추가 가능)
st.set_page_config(page_title="홀몬 정보", layout="wide")
...
# 타이틀
st.write("### 우리몸의 지배자, 홀몬! 👋")

# 설명 텍스트 (bold 및 색상 적용)
st.markdown("""
<span class="highlight">모르는 체 지낼까요, 소통하며 잘 지낼까요</span>  
여기 Kevin이 맛깔나게 여러 각도에서 제안을 합니다.  
<span class="highlight">아래 3편을 의미 있게 보시길</span>  
""", unsafe_allow_html=True)


# Video 링크 버튼
st.link_button("Video 를 통해 보기", "https://youtu.be/W7dtwzON0m8")

# # 대화 링크 버튼
st.link_button("대화 를 통해 듣기", "https://youtu.be/Nwl5T50elYU")
